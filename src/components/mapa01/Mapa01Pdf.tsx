  ...
  return (
    <>
      ...
      <View style={styles.row}>
        ...
        <Cell width="65%">
          <Checkbox checked={getChecked("Konteks Asesmen", "LSP LPK GATAKSINDO")} label="LSP LPK GATAKSINDO" />
      ...
      <View style={styles.row}>
        ...
        <Cell width="77%">
          <Checkbox checked={getChecked("Orang yang relevan untuk dikonfirmasi", "Manajer sertifikasi LSP LPK GATAKSINDO")} label="Manajer sertifikasi LSP LPK GATAKSINDO" />
