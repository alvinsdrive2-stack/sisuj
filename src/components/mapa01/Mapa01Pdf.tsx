  ...
  return (
    <>
      ...
      <View style={styles.row}>
        ...
        <Cell width="65%">
          <Checkbox checked={getChecked("Konteks Asesmen", "LSP LSP LPK GATAKSINDO")} label="LSP LSP LPK GATAKSINDO" />
      ...
      <View style={styles.row}>
        ...
        <Cell width="77%">
          <Checkbox checked={getChecked("Orang yang relevan untuk dikonfirmasi", "Manajer sertifikasi LSP LSP LPK GATAKSINDO")} label="Manajer sertifikasi LSP LSP LPK GATAKSINDO" />
