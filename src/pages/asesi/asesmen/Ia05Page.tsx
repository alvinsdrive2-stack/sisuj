...
export default function Ia05Page() {
  ...
  const { jenjang, metode, jabatanKerja, nomorSkema, tuk, asesorList, namaAsesi, idAsesor1: _idAsesor1, namaPenyusun, namaValidator, tanggalPenyusun, tanggalValidator, barcodePenyusun, barcodeValidator, noregPenyusun, noregValidator, jenisKelas, isLoading: isDataLoading, jadwalId } = useDataDokumenAsesmen(id)
  ...
  const handleSubmit = useCallback(async () => {
    // Tahap 0: skip save/TTD, langsung balik ke dashboard asesor
    if (tahap === 0) {
          ...
          <div style={{ display: 'flex', gap: '12px', justifyContent: 'flex-end' }}>
            ...
            {isAsesi && (
              <>
                ...
                <ActionButton variant="primary" disabled={isSaving || (tahap !== 0 && !signing.asesiHasSigned && (!signing.agreedChecklist || isExpired))} onClick={tahap === 0 ? () => navigate(`/asesor/asesi/${jadwalId}`) : handleSubmit}>
            ...
            {isAsesor && (
              <>
                ...
                <ActionButton variant="secondary" onClick={() => navigate(-1)}>
                  ...
                  <ActionButton variant="primary" disabled={isSaving || (tahap !== 0 && !signing.asesorHasSigned && !signing.agreedChecklist)} onClick={handleSaveUmpanBalik}>
