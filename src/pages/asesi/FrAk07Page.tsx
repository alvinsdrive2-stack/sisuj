...
export default function FrAk07Page() {
  ...
  const handleSave = () => {
    ...
    navigate(`/asesi/praasesmen/${kegiatanId}/fr-ak-04`)
  }
    ...
    <div style={{ minHeight: '100vh', background: '#f5f5f5', fontFamily: 'Arial, Helvetica, sans-serif' }}>
      ...
      <AsesiLayout currentStep={6}>
        ...
        <div style={{ marginBottom: '20px' }}>
          <h2 style={{ fontSize: '16px', fontWeight: 'bold', color: '#000', marginBottom: '4px', textTransform: 'uppercase' }}>FR.AK.07 - FORMULIR AK 07</h2>
          <p style={{ fontSize: '13px', color: '#666' }}>Isi atau lengkapi data formulir AK 07 di bawah ini</p>
        </div>

        {/* Content */}
        <div style={{ background: '#fff', border: '1px solid #000', borderRadius: '8px', padding: '40px', textAlign: 'center', marginBottom: '20px' }}>
          <p style={{ fontSize: '14px', color: '#666' }}>Formulir AK 07 sedang dalam pengembangan</p>
        </div>
